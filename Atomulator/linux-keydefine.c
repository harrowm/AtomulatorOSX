...
// HACK - doesnt seem to be called from anywhere
...
//			;
//		k2 = readkey() >> 8;
//		if (k2 == ALLEGRO_KEY_F11 || k2 == ALLEGRO_KEY_F12)
//			goto getnewkey;
//		keylookup[k2] = k;
//
//		blit(b, screen, 0, 0, x, y, 200, 72);
//		destroy_bitmap(b);
//		while (al_key_down(&keybd, ALLEGRO_KEY_SPACE))
//			;
//		while (keypressed())
//			readkey();
//		return 0;
...
//	{ d_getkey,	 42 + 24,  106, 28,  28,   15, 15, 0, D_EXIT,  0,     0, "CTL",	   (void*)ALLEGRO_KEY_LCONTROL,	  "CTRL"       },
...
//	{ d_getkey,	 346 + 24, 138, 28,  28,   15, 15, 0, D_EXIT,  0,     0, ".",	   (void*)ALLEGRO_KEY_STOP,	  NULL	       },
...
//	dp = init_dialog(d, 0);
//	while (x && !al_key_down(&keybd, KEY_F11) && !(mouse_b & 2) && !al_key_down(&keybd, KEY_ESC))
//	{
//		x = update_dialog(dp);
//	}
//	shutdown_dialog(dp);
