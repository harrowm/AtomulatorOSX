...
int fastsid_calculate_samples(sound_t *psid, SWORD *pbuf, int nr, int sample_in_ptr)
{
    DWORD o0, o1, o2;
	...
	uint8_t * sample_buf = psid->sample_buf;
    ...
    for (i = 0; i < nr; i++) {
        ...
        pbuf[i] = ((SDWORD)((o0 + o1 + o2) >> 20) - 0x600)
		* psid->vol;
    }
...
void fastsid_reset(sound_t *psid)
{
    WORD addr;
