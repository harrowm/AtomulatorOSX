...
static int getftell()
{
	return (int)gztell(uef);
}

static void rewindit()
{
	int c;
...
uint8_t fdat;
int ffound;
static void receiveuef(uint8_t val)
{
	if (infilenames)
	{
		ffound = 1;
